...
class Worker(QObject):
    ...
    request_category_mapping = pyqtSignal(str)  # Signal to request category mapping from UI
    ...
    def run(self):
        try:
            ...
            pipeline_result = self.pipeline.run(self.main_df, self.selected_categories, self.options)
