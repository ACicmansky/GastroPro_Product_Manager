...
from PyQt5.QtWidgets import (
    QFrame, QLabel, QVBoxLayout, QDialog, QLineEdit,
...
class CategoryMappingDialog(QDialog):
    ...
    def init_ui(self):
        ...
        if self.product_name:
            ...
            product_label.setStyleSheet("padding: 8px; background-color: #e3f2fd; border-left: 4px solid #2196F3; margin-bottom: 15px;")
        ...
        original_label.setStyleSheet("padding: 10px; background-color: #f0f0f0; border-radius: 5px; margin-bottom: 15px;")
