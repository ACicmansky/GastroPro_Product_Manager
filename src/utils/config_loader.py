...
def save_category_mapping(old_category: str, new_category: str, mappings_path: str = 'categories.json') -> bool:
...
class CategoryMappingManager:
    ...
    def add_mapping(self, old_category: str, new_category: str) -> bool:
        ...
        with self._lock:
            ...
            for mapping in self._mappings:
                if mapping.get("oldCategory") == old_category:
                    print(f"Mapping for '{old_category}' already exists in cache, skipping.")
                    return False
