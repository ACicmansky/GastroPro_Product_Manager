...
class TestPipelineNewFormat:
    ...
    def test_pipeline_merges_multiple_feeds(self, config, sample_xml_gastromarket, 
                                           sample_xml_forgastro):
...
class TestPipelineEndToEnd:
    ...
    def test_complete_pipeline_run(self, config, sample_xml_gastromarket, test_data_dir):
    ...
    def test_pipeline_with_all_steps(self, config, sample_xml_gastromarket, test_data_dir):
