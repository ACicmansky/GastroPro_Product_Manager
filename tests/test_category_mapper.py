...
class TestCurrentCategoryMapping:
    ...
    def test_map_dataframe_categories(self, sample_old_format_df, sample_category_mappings):
        ...
        assert 'Mapped Category 1' in mapped_values or 'Category1/SubCat1' in mapped_values
    
    def test_map_dataframe_preserves_other_columns(self, sample_old_format_df, sample_category_mappings):
    ...
    def test_map_category_normalization(self):
        ...
        mappings = [
            {"oldCategory": "Normal Category", "newCategory": "Mapped"}
        ]
...
class TestCategoryMappingManager:
    ...
    def test_category_manager_add_mapping(self):
        ...
        try:
            ...
            found = any(
                m['oldCategory'] == 'Test Old Category' and 
                m['newCategory'] == 'Test New Category'
                for m in mappings
            )
