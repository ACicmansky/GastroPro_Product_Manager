...
class TestXMLParserNewFormat:
    ...
    def test_parse_handles_images(self, sample_xml_gastromarket, config):
        ...
        has_images = result['defaultImage'].notna().any() or (result['defaultImage'] != '').any()
...
class TestXMLParserIntegration:
    ...
    def test_multiple_feeds_same_format(self, sample_xml_gastromarket, 
                                       sample_xml_forgastro, config):
